...
MODEL_PATH="${1:-$LATENT_SKETCHPAD_ROOT/outputs/3dproject_stage1_qwen35_full}"
OUTPUT_ROOT="${2:-$LATENT_SKETCHPAD_ROOT/outputs/3dproject_stage1_qwen35_full/test_eval_final}"
